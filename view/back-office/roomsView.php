                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" id="title" value="<?php echo $room_title; ?>"
                                       class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <?php if (!empty($current_img)) : ?>
                                ...
                                <div class="form-group text-center">
                                    ...
                                    <hr>
                                    <img src="<?php echo URL; ?>img/<?php echo $current_img; ?>" class="w-25 img-thumbnail"
...
<?php
if (!user_is_admin()) {
    $title = 'Accès interdit (rooms view)';
