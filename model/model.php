...
function saveUserByAdmin()
{
    ...
    if (!empty($user_id)) {
        $save = $pdo->prepare("UPDATE membre SET id_membre = :userId, pseudo = :pseudo, nom = :nom, prenom = :prenom, email = :email, civilite = :civilite, statut = :statut WHERE id_membre = :userId");
